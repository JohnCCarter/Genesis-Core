...
- **Baseline / frozen references:**
  - `docs/decisions/ri_router_replay_implementation_packet_2026-04-23.md`
...
1. `pre-commit run --files GENESIS_WORKING_CONTRACT.md docs/decisions/ri_router_replay_defensive_transition_semantics_packet_2026-04-23.md`
