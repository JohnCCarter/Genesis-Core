...
- `docs/decisions/diagnostic_campaigns/edge_classification_phase13_packet_2026-04-02.md` explicitly forbids `SUPPORTED` for `structural_market_microstructure` because no packet-authorized market-microstructure artifact surface exists in the locked inputs.
