...
- **Expected changed files:** `docs/governance/current_atr_1435_default_off_rollout_boundary_packet_2026-04-16.md`
- **Max files touched:** `1`
...
- `pre-commit run --files docs/governance/current_atr_1435_default_off_rollout_boundary_packet_2026-04-16.md`
