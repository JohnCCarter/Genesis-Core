...
ARTIFACT_DIR = (
    ...
    / "results"
    / "backtests"
    / "ri_policy_router_continuation_release_hysteresis_topline_subject_20260504"
)
SUMMARY_PATH = ARTIFACT_DIR / "continuation_release_hysteresis_topline_subject_summary.json"
ROW_DIFFS_PATH = ARTIFACT_DIR / "continuation_release_hysteresis_topline_subject_row_diffs.json"
