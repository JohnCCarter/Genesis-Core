...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/debug/2026-02-14/diagnose_zero_trades.py").resolve()
    print(
        "[DEPRECATED] scripts/diagnose_zero_trades.py moved to scripts/archive/debug/2026-02-14/diagnose_zero_trades.py.",
        file=sys.stderr,
    )
