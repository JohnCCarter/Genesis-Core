...
- **Expected changed files:** `docs/governance/regime_intelligence_experiment_map_reselection_regime_definition_candidate_surface_packet_2026-03-30.md`
- **Max files touched:** `1`
...
- `docs/governance/regime_intelligence_upstream_diagnostic_path_closeout_2026-03-30.md`
...
- `docs/governance/regime_intelligence_signal_regime_definition_roadmap_2026-03-27.md`
...
- it matches the earlier regime-definition planning line already documented in `docs/governance/regime_intelligence_signal_regime_definition_roadmap_2026-03-27.md`
