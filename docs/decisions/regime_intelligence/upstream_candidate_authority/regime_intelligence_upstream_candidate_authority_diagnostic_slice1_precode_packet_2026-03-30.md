...
- **Expected changed files:** `docs/decisions/regime_intelligence/upstream_candidate_authority/regime_intelligence_upstream_candidate_authority_diagnostic_slice1_precode_packet_2026-03-30.md`
- **Max files touched:** `1`
