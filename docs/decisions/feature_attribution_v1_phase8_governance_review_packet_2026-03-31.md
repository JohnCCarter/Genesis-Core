...
- **Expected changed files:** `docs/decisions/feature_attribution_v1_phase8_governance_review_packet_2026-03-31.md`
- **Max files touched:** `1`
...
- `docs/decisions/regime_intelligence_p1_off_parity_governed_rerun_execution_review_2026-03-17.md` is a structural analogy only
- `docs/analysis/regime_intelligence_optuna_challenger_family_promotion_readiness_assessment_2026-03-26.md` is a structural analogy only
