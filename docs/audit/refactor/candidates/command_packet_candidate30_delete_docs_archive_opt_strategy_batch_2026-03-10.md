# Command Packet — Candidate 30 Delete deprecated optimization/strategy docs batch (2026-03-10)
...
- **Required Path:** `Full`
- **Objective:** Continue governed cleanup by deleting 2 low-risk deprecated optimization/strategy docs.
...
- **Scope IN:**
  - Delete targets listed in `docs/audit/refactor/evidence/candidate30_opt_strategy_delete_manifest_2026-03-10.tsv` (2 files)
  ...
  - `docs/audit/refactor/evidence/candidate30_post_delete_scope_drift_2026-03-10.txt` (to be generated)
  - `docs/audit/refactor/evidence/candidate30_gate_transcript_2026-03-10.md` (to be generated)
  - `docs/audit/refactor/evidence/candidate30_gate_raw_output_2026-03-10.txt` (to be generated)
  - `docs/audit/refactor/evidence/candidate30_opt_strategy_implementation_report_2026-03-10.md` (to be generated)
  - `docs/audit/refactor/evidence/candidate30_pr_evidence_template_2026-03-10.md` (to be generated)
- **Scope OUT:**
  - `src/**`
  - `config/**`
...
- **Expected changed files:** `14` (2 deletes + 12 governance/evidence files)
- **Max files touched:** `17`

### Constraints

Constraint: **NO BEHAVIOR CHANGE**.
Primary change set for Candidate30 is deletion of the 2 manifest-listed files only.
Primary change scope is deletion of exactly the 2 manifest-listed archive docs.
...
- Candidate decision: `docs/audit/refactor/evidence/docs_archive_triage_opt_strategy_batch_candidate30_decision_2026-03-10.md`
- Manifest: `docs/audit/refactor/evidence/candidate30_opt_strategy_delete_manifest_2026-03-10.tsv`
...
- Scope drift proof (to generate): `docs/audit/refactor/evidence/candidate30_post_delete_scope_drift_2026-03-10.txt`
- Gate transcript (to generate): `docs/audit/refactor/evidence/candidate30_gate_transcript_2026-03-10.md`
- Gate raw output (to generate): `docs/audit/refactor/evidence/candidate30_gate_raw_output_2026-03-10.txt`
...
- Invocation evidence: `docs/audit/refactor/evidence/candidate30_skill_invocation_2026-03-10.txt`.
...
- Run full gate set **pre** and **post** Candidate30 deletion.
