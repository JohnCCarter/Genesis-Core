# Command Packet — Archive Audit Candidate 3 Batch A (2026-03-06)
...
- **Candidate:** `deprecated_wrapper_batch_A` (3 files)
- **Base SHA:** `378017e07f49a5f6fb68a7d508d0f557ab2671d5`
- **Working branch:** `feature/refactor-scripts-structure-a`

### Scope

- **Scope IN:**
  - `scripts/archive/deprecated_2026-02/diagnose_cooldown_vetoes.py`
  - `scripts/archive/deprecated_2026-02/diagnose_execution_gap_v2.py`
  - `scripts/archive/deprecated_2026-02/diagnose_execution_layer_gap.py`
  - `docs/audit/refactor/command_packet_archive_audit_candidate3_batchA_2026-03-06.md`
- **Scope OUT:**
  - `src/**`
  - `config/**`
  - `mcp_server/**`
...
- **Expected changed files:**
  ...
  - `docs/audit/refactor/command_packet_archive_audit_candidate3_batchA_2026-03-06.md`
- **Max files touched:** `4`
- **Hard lock:** one-candidate-per-PR (`deprecated_wrapper_batch_A`) with explicit no-active-reference evidence before action.
...
- All three files are wrapper-only (deprecated print + deprecated usage log + `runpy` handoff).
- Target files exist:
...
- Active reference check:
  - `git grep -n -E "diagnose_cooldown_vetoes\.py|diagnose_execution_gap_v2\.py|diagnose_execution_layer_gap\.py" -- . ":(exclude)scripts/archive/**" ":(exclude)docs/archive/**"` returned no hits.
