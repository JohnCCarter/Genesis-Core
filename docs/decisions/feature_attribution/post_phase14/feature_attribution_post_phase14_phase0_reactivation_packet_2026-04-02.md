...
Status: `historical post-Phase-14 reactivation packet / retained for provenance / not current branch guidance`
...
> `feature/ri-role-map-implementation-2026-03-24` context. The lane-opening, candidate-ordering,
> and next-step wording below do **not** reopen Feature Attribution or create current branch
