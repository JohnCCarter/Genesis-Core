...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/2026-02/analysis/join_holdout_blocks.py").resolve()
    print(
        "[DEPRECATED] scripts/join_holdout_blocks.py moved to scripts/archive/2026-02/analysis/join_holdout_blocks.py.",
        file=sys.stderr,
    )
