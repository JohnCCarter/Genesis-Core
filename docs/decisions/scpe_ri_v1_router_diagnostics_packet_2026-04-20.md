...
- `pre-commit run --files docs/decisions/scpe_ri_v1_router_diagnostics_packet_2026-04-20.md docs/analysis/scpe_ri_v1_router_diagnostics_report_2026-04-20.md scripts/analyze/scpe_ri_v1_router_diagnostics.py results/evaluation/scpe_ri_v1_router_diagnostics_2026-04-20.json`
