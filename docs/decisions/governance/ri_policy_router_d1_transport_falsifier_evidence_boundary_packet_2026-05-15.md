...
4. `docs/analysis/diagnostics/genesis_core_premortem_feature_evidence_closeout_pilot_2026-05-15.md` explicitly calls for defining the RI/policy-router transport/falsifier gate before any candidate-promotion language is allowed.
