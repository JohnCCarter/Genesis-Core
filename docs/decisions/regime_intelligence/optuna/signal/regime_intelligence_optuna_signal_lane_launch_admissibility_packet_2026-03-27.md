...
- **Expected changed files:** `docs/decisions/regime_intelligence/optuna/signal/regime_intelligence_optuna_signal_lane_launch_admissibility_packet_2026-03-27.md`
- **Max files touched:** `1`
