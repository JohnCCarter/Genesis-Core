...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/analysis/feature_ic_v18.py").resolve()
    print(
        "[DEPRECATED] scripts/feature_ic_v18.py moved to scripts/archive/analysis/feature_ic_v18.py.",
        file=sys.stderr,
    )
