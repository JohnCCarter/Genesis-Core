# Command Packet — Candidate 23 Delete deprecated paper_trading/templates batch (2026-03-10)
...
- **Required Path:** `Full`
- **Objective:** Increase curation throughput safely by deleting 11 low-risk deprecated archive docs in two concentrated subtrees.
- **Candidate:** `delete_docs_archive_paper_trading_templates_batch_candidate23`
- **Base SHA:** `963e7436`

### Scope

- **Scope IN:**
  - Delete targets listed in `docs/audit/refactor/evidence/candidate23_paper_trading_templates_delete_manifest_2026-03-10.tsv` (11 files)
  ...
  - `docs/audit/refactor/evidence/candidate23_post_delete_scope_drift_2026-03-10.txt` (to be generated)
  - `docs/audit/refactor/evidence/candidate23_gate_transcript_2026-03-10.md` (to be generated)
  - `docs/audit/refactor/evidence/candidate23_paper_trading_templates_implementation_report_2026-03-10.md` (to be generated)
  - `docs/audit/refactor/evidence/candidate23_pr_evidence_template_2026-03-10.md` (to be generated)
- **Scope OUT:**
  - `src/**`
  - `config/**`
...
- **Expected changed files:** `22` (11 deletes + up to 11 governance/evidence files)
...
- Candidate decision: `docs/audit/refactor/evidence/docs_archive_triage_paper_trading_templates_batch_candidate23_decision_2026-03-10.md`
- Manifest: `docs/audit/refactor/evidence/candidate23_paper_trading_templates_delete_manifest_2026-03-10.tsv`
- Path refcheck: `docs/audit/refactor/evidence/candidate23_paper_trading_templates_path_refcheck_2026-03-10.txt`
...
- Scope drift proof (to generate): `docs/audit/refactor/evidence/candidate23_post_delete_scope_drift_2026-03-10.txt`
- Gate transcript (to generate): `docs/audit/refactor/evidence/candidate23_gate_transcript_2026-03-10.md`
...
- Invocation evidence: `docs/audit/refactor/evidence/candidate23_skill_invocation_2026-03-10.txt`.
...
- Run full gate set **pre** and **post** candidate23 deletion.
