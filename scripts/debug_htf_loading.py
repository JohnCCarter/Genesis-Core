...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/debug/2026-02-14/debug_htf_loading.py").resolve()
    print(
        "[DEPRECATED] scripts/debug_htf_loading.py moved to scripts/archive/debug/2026-02-14/debug_htf_loading.py.",
        file=sys.stderr,
    )
