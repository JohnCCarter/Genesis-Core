...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/analysis/compare_swing_strategies.py").resolve()
    print(
        "[DEPRECATED] scripts/compare_swing_strategies.py moved to scripts/archive/analysis/compare_swing_strategies.py.",
        file=sys.stderr,
    )
