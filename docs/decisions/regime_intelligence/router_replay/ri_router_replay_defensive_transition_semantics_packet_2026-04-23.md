...
1. `pre-commit run --files GENESIS_WORKING_CONTRACT.md docs/decisions/regime_intelligence/router_replay/ri_router_replay_defensive_transition_semantics_packet_2026-04-23.md`
