# Repo Cleanup D13 Minimal Execution Contract (2026-02-15)
...
- Move-only execution av exakt tre filer:
  1. `results/hparam_search/run_20251227_180204/trial_015.log`
  2. `results/hparam_search/run_20251227_180204/trial_016.log`
  3. `results/hparam_search/run_20251227_180204/trial_017.log`
- Målvägar (mirror under orphaned archive):
  1. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_015.log`
  2. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_016.log`
  3. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_017.log`
...
3. D13 kontrakt + rapport skapade.
...
- D13 i denna tranche är en minimal execution-batch med explicit hantering av
