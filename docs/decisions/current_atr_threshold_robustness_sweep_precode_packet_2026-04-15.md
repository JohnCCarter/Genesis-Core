...
- **Scope IN:**
  - `docs/decisions/current_atr_threshold_robustness_sweep_precode_packet_2026-04-15.md`
...
- `pre-commit run --files docs/decisions/current_atr_threshold_robustness_sweep_precode_packet_2026-04-15.md tmp/current_atr_threshold_robustness_sweep_20260415.py`
