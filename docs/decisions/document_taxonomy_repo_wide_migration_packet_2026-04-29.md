...
Status: `historical migration packet / docs-only / non-authorizing`

> Current status note: this file is retained as historical repo-wide migration decision context
