...
- **Scope IN:**
  - `docs/decisions/regime_intelligence/advisory_environment_fit/ri_advisory_environment_fit_phase3_carrier_materialization_admissibility_packet_2026-04-16.md`
  - `docs/analysis/regime_intelligence/advisory_environment_fit/ri_advisory_environment_fit_phase3_carrier_materialization_admissibility_2026-04-16.md`
- **Scope OUT:**
  - `src/**`
  - `tests/**`
  - `config/**`
...
- `pre-commit run --files docs/decisions/regime_intelligence/advisory_environment_fit/ri_advisory_environment_fit_phase3_carrier_materialization_admissibility_packet_2026-04-16.md docs/analysis/regime_intelligence/advisory_environment_fit/ri_advisory_environment_fit_phase3_carrier_materialization_admissibility_2026-04-16.md`
...
- `docs/analysis/regime_intelligence/advisory_environment_fit/ri_advisory_environment_fit_phase3_carrier_adequacy_2026-04-16.md`
...
- `docs/analysis/regime_intelligence/core/regime_intelligence_phase_bc_rerun_plan_2026-03-13.md`
