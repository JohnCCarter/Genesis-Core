...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/experiments/run_timeframe_sweep.py").resolve()
    print(
        "[DEPRECATED] scripts/run_timeframe_sweep.py moved to scripts/archive/experiments/run_timeframe_sweep.py.",
        file=sys.stderr,
    )
