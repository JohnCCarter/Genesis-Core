...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/2026-02/analysis/evaluate_all_models.py").resolve()
    print(
        "[DEPRECATED] scripts/evaluate_all_models.py moved to scripts/archive/2026-02/analysis/evaluate_all_models.py.",
        file=sys.stderr,
    )
