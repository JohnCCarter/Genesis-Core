...
- **Candidate:** `tests/test_backtest_debug_env_flag.py -> tests/backtest/test_backtest_debug_env_flag.py`
- **Base SHA:** `3c185a83`
- **Category:** `tooling`
...
- **Scope IN:**
  - `tests/test_backtest_debug_env_flag.py` (move source)
  - `tests/backtest/test_backtest_debug_env_flag.py` (move target)
  - `docs/audit/refactor/tests_subfolder_classification_plan_2026-03-09.md` (classification/reference update)
  - `docs/audit/refactor/command_packet_tests_subfolder_classification_backtest_bt5_2026-03-09.md`
- **Scope OUT:**
...
- `python -m ruff check .`
- `python -m pytest -q tests/backtest/test_backtest_debug_env_flag.py`
- `python -m pytest -q`
...
- `C:/Users/fa06662/Projects/Genesis-Core/.venv/Scripts/python.exe -m pytest -q tests/backtest/test_backtest_debug_env_flag.py`: **PASS**
