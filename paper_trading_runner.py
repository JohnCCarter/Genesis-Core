...
_TARGET = (
    ...
    / "scripts/archive/2026-02/analysis/paper_trading_runner.py"
).resolve()
...
def _run_deprecated_cli() -> int:
    print(
        "[DEPRECATED] paper_trading_runner.py moved to scripts/archive/2026-02/analysis/paper_trading_runner.py.",
        file=sys.stderr,
    )
    argv = sys.argv[:]
