...
- **Baseline / frozen references:**
  ...
  - `docs/decisions/regime_intelligence/policy_router/ri_policy_router_low_zone_bars8_evidence_floor_runtime_packet_2026-04-27.md`
...
1. `pre-commit run --files GENESIS_WORKING_CONTRACT.md docs/decisions/regime_intelligence/policy_router/ri_policy_router_aged_weak_plus_stability_interaction_precode_packet_2026-04-27.md`
