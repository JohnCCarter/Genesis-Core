...
def test_1d_optimization(config_name, config_data):
    ...
    try:
        ...
        if results and 'summary' in results:
            ...
            print(f"  ERROR: Ingen summary i results")
            return {
                'name': config_data['name'],
                'config_name': config_name,
                'success': False,
...
def test_all_1d_optimizations():
    ...
    try:
        ...
        with open("1d_optimized_configs.json", 'r') as f:
...
def analyze_results(results):
    ...
    if successful_results:
        ...
        best_result = max(successful_results, key=lambda x: x['sharpe'] if x['sharpe'] > 0 else -999)
