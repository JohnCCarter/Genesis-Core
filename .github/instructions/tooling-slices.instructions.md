...
- Treat `.github/**` as workspace customization surfaces for editor-agent operations, not as new governance SSOT.
...
- Keep diffs minimal and parity-oriented when touching tooling or config surfaces.
...
- If a tooling change would alter runtime behavior, governance precedence, shared-truth write paths, or MCP server authority without explicit scope, stop and escalate.
