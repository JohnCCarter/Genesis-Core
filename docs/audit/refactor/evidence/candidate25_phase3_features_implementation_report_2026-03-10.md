...
- `docs/audit/refactor/candidates/command_packet_candidate25_delete_docs_archive_phase3_features_batch_2026-03-10.md` _(current retained path after later taxonomy move)_
