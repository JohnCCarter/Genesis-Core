# Repo Cleanup D17 Minimal Execution Contract (2026-02-15)
...
- Move-only execution av exakt tre filer:
  1. `results/hparam_search/run_20251227_180204/trial_027.log`
  2. `results/hparam_search/run_20251227_180204/trial_028.log`
  3. `results/hparam_search/run_20251227_180204/trial_029.log`
- Målvägar (mirror under orphaned archive):
  1. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_027.log`
  2. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_028.log`
  3. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_029.log`
...
- Basename-referenser finns i run-artefakter och accepteras som residual risk:
  - `results/hparam_search/run_20251227_180204/trial_027.json:113`
  - `results/hparam_search/run_20251227_180204/trial_028.json:113`
  - `results/hparam_search/run_20251227_180204/trial_029.json:113`
...
2. D17 kontrakt + rapport skapade.
...
- D17 i denna tranche är en minimal execution-batch med explicit noterad basename-residual risk.
