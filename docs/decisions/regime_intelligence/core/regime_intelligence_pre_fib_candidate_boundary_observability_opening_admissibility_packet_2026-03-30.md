...
- **Expected changed files:** `docs/decisions/regime_intelligence/core/regime_intelligence_pre_fib_candidate_boundary_observability_opening_admissibility_packet_2026-03-30.md`
- **Max files touched:** `1`
