...
- `docs/audit/refactor/candidates/command_packet_candidate27_delete_docs_archive_analysis_calibration_risk_batch_2026-03-10.md` _(current retained path after later taxonomy move)_
