...
- **Expected changed files:** `docs/governance/regime_intelligence_experiment_map_reselection_phase5_precode_binding_note_2026-03-30.md`
- **Max files touched:** `1`
...
- the chain is bound to the already existing bounded pre-code packet `docs/governance/regime_intelligence_optuna_signal_regime_definition_slice1_precode_command_packet_2026-03-27.md`
