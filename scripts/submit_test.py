...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/test_prototypes/submit_test.py").resolve()
    print(
        "[DEPRECATED] scripts/submit_test.py moved to scripts/archive/test_prototypes/submit_test.py.",
        file=sys.stderr,
    )
