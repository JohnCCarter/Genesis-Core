...
- **Baseline reference(s):** `docs/analysis/diagnostics/next_phase_verkstad_queue_2026-05-15.md`, `docs/analysis/diagnostics/genesis_core_premortem_feature_evidence_closeout_pilot_2026-05-15.md`, `docs/governance/runbooks/evidence_claim_adoption.md`, `docs/governance/templates/evidence_claim_header.md`, `docs/governance/runbooks/editor_slice_worker_dispatch.md`
