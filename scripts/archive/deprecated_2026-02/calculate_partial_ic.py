...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/analysis/calculate_partial_ic.py").resolve()
    print(
        "[DEPRECATED] scripts/calculate_partial_ic.py moved to scripts/archive/analysis/calculate_partial_ic.py.",
        file=sys.stderr,
    )
