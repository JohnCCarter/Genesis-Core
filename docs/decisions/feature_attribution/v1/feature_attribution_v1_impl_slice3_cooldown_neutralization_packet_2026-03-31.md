...
Status: `historical Feature Attribution v1 implementation slice 3 packet / retained for provenance / not current branch guidance`
...
- **Expected changed files:** `docs/decisions/feature_attribution/v1/feature_attribution_v1_impl_slice3_cooldown_neutralization_packet_2026-03-31.md`, `src/core/strategy/decision.py`, `tests/utils/test_decision_edge.py`
- **Max files touched:** `3`
