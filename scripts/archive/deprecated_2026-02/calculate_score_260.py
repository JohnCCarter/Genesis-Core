...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/2026-02/analysis/calculate_score_260.py").resolve()
    print(
        "[DEPRECATED] scripts/calculate_score_260.py moved to scripts/archive/2026-02/analysis/calculate_score_260.py.",
        file=sys.stderr,
    )
