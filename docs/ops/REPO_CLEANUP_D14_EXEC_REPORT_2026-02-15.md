# Repo Cleanup D14 Minimal Execution Report (2026-02-15)
...
1. Från `results/hparam_search/run_20251227_180204/trial_018.log`
   till `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_018.log`
2. Från `results/hparam_search/run_20251227_180204/trial_019.log`
   till `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_019.log`
3. Från `results/hparam_search/run_20251227_180204/trial_020.log`
   till `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_020.log`
...
- Exakta path-referenser för `trial_018/019/020.log` gav inga träffar.
- Destinationerna för `trial_018/019/020.log` var frånvarande före move (no-overwrite).

## Scope-verifiering

- Ingen `.gitignore`-ändring i D14.
...
- D14 minimal execution tranche: införd.
- Vidare execution utanför scopead D14-batch: fortsatt föreslagen.
