...
- **Required Path:** `Full`
- **Objective:** Execute Phase 2A micro-batch 3C by relocating one performance candidate to `tests/experiments/` with minimal reversible diff.
- **Candidate:** `tests/test_performance_improvements_2025.py -> tests/experiments/test_performance_improvements_2025.py`
- **Base SHA:** `d9e25af9`

### Scope

- **Scope IN:**
  - `tests/test_performance_improvements_2025.py` (move source)
  - `tests/experiments/test_performance_improvements_2025.py` (move target)
  - `docs/audit/refactor/tests_subfolder_classification_plan_2026-03-09.md` (status/reference update)
  - `docs/audit/refactor/command_packet_tests_subfolder_classification_phase2a_batch3c_2026-03-09.md`
- **Scope OUT:**
...
- `python -m ruff check .`
- `python -m pytest -q tests/experiments/test_performance_improvements_2025.py`
- `python -m pytest -q`
...
- `python -m pytest -q tests/experiments/test_performance_improvements_2025.py`: **PASS**
