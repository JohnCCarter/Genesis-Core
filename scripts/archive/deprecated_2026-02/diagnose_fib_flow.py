...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/debug/2026-02-14/diagnose_fib_flow.py").resolve()
    print(
        "[DEPRECATED] scripts/diagnose_fib_flow.py moved to scripts/archive/debug/2026-02-14/diagnose_fib_flow.py.",
        file=sys.stderr,
    )
