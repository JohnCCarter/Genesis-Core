...
def test_1h_trend_favoring():
    ...
    print("=" * 60)
    print("TESTING 1H - TREND-FAVORING REGIME PROBA")
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    if result:
        print(f"\n=== COMPARISON ===")
        print(f"Previous (All 0.6): +3.36% return, 30.3% win rate, 33 trades")
        print(f"Current (Trend-Favoring): {result['return']:.2f}% return, {result['win_rate']:.1f}% win rate, {result['trades']} trades")
