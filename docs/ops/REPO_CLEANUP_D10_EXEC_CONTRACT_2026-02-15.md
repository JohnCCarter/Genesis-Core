# Repo Cleanup D10 Minimal Execution Contract (2026-02-15)
...
- Move-only execution av exakt tre filer:
  1. `results/hparam_search/run_20251227_180204/trial_006.log`
  2. `results/hparam_search/run_20251227_180204/trial_007.log`
  3. `results/hparam_search/run_20251227_180204/trial_008.log`
- Målvägar (mirror under orphaned archive):
  1. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_006.log`
  2. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_007.log`
  3. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_008.log`
...
2. D10 kontrakt + rapport skapade.
...
- D10 i denna tranche är en minimal execution-batch med strikt scope.
