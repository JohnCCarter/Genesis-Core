...
- **Expected changed files:** `docs/decisions/feature_attribution_v1_phase4_runner_boundary_packet_2026-03-31.md`
- **Max files touched:** `1`
...
- `docs/decisions/regime_intelligence_p1_off_parity_governed_rerun_execution_plan_2026-03-17.md` is a structural analogy only
