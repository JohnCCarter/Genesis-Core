# Repo Cleanup D19 Minimal Execution Contract (2026-02-15)
...
- Move-only execution av exakt tre filer:
  1. `results/hparam_search/run_20251227_180204/trial_033.log`
  2. `results/hparam_search/run_20251227_180204/trial_034.log`
  3. `results/hparam_search/run_20251227_180204/trial_035.log`
- Målvägar (mirror under orphaned archive):
  1. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_033.log`
  2. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_034.log`
  3. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_035.log`
...
- Basename-referenser finns i run-artefakter och accepteras som residual risk:
  - `results/hparam_search/run_20251227_180204/trial_033.json:111`
  - `results/hparam_search/run_20251227_180204/trial_034.json:111`
  - `results/hparam_search/run_20251227_180204/trial_035.json:113`
  - `results/hparam_search/run_20251227_180204/_cache/*.json:12|14`
...
2. D19 kontrakt + rapport skapade.
...
- D19 i denna tranche är en minimal execution-batch med explicit noterad basename-residual risk.
