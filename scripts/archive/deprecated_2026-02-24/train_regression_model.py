...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/experiments/train_regression_model.py").resolve()
    print(
        "[DEPRECATED] scripts/train_regression_model.py moved to scripts/archive/experiments/train_regression_model.py.",
        file=sys.stderr,
    )
