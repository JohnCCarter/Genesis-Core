...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/test_prototypes/2026-02-14/test_sse_local.py").resolve()
    print(
        "[DEPRECATED] scripts/test_sse_local.py moved to scripts/archive/test_prototypes/2026-02-14/test_sse_local.py.",
        file=sys.stderr,
    )
