...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/debug/2026-02-14/debug_config_merge.py").resolve()
    print(
        "[DEPRECATED] scripts/debug_config_merge.py moved to scripts/archive/debug/2026-02-14/debug_config_merge.py.",
        file=sys.stderr,
    )
