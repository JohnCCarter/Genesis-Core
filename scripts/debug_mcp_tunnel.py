...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/debug/2026-02-14/debug_mcp_tunnel.py").resolve()
    print(
        "[DEPRECATED] scripts/debug_mcp_tunnel.py moved to scripts/archive/debug/2026-02-14/debug_mcp_tunnel.py.",
        file=sys.stderr,
    )
