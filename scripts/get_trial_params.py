...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/2026-02/analysis/get_trial_params.py").resolve()
    print(
        "[DEPRECATED] scripts/get_trial_params.py moved to scripts/archive/2026-02/analysis/get_trial_params.py.",
        file=sys.stderr,
    )
