...
- **Candidate:** `tests/test_backtest_metrics.py -> tests/backtest/test_backtest_metrics.py`
- **Base SHA:** `c05f5ab5`

### Scope

- **Scope IN:**
  - `tests/test_backtest_metrics.py` (move source)
  - `tests/backtest/test_backtest_metrics.py` (move target)
  - `docs/audit/refactor/tests_subfolder_classification_plan_2026-03-09.md` (classification/reference update)
  - `docs/audit/refactor/command_packet_tests_subfolder_classification_backtest_bt2_2026-03-09.md`
- **Scope OUT:**
...
- `python -m ruff check .`
- `python -m pytest -q tests/backtest/test_backtest_metrics.py`
- `python -m pytest -q`
...
- `C:/Users/fa06662/Projects/Genesis-Core/.venv/Scripts/python.exe -m pytest -q tests/backtest/test_backtest_metrics.py`: **PASS**
