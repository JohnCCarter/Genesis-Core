# Repo Cleanup D3F Execution Contract (2026-02-14)
...
- `scripts/test_fibonacci_exits_real_backtest.py` (move)
- `scripts/test_rest_auth.py` (move)
- `scripts/test_ws_auth.py` (move)
- `scripts/archive/test_prototypes/2026-02-14/test_fibonacci_exits_real_backtest.py` (new path)
- `scripts/archive/test_prototypes/2026-02-14/test_rest_auth.py` (new path)
- `scripts/archive/test_prototypes/2026-02-14/test_ws_auth.py` (new path)
...
- Historiska docs-referenser uppdateras inte i D3F; påverkan dokumenteras i rapporten.

## Done criteria

1. Exakt 3 script flyttade till målpaths med rename-integritet.
2. D3F kontrakt + exekveringsrapport dokumenterade.
...
- D3F i detta kontrakt är kandidatvis destruktiv flytt av tre testscript med låg referensyta.
