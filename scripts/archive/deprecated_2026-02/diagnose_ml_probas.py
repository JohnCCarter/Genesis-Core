...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/debug/2026-02-14/diagnose_ml_probas.py").resolve()
    print(
        "[DEPRECATED] scripts/diagnose_ml_probas.py moved to scripts/archive/debug/2026-02-14/diagnose_ml_probas.py.",
        file=sys.stderr,
    )
