...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/experiments/train_meta_model.py").resolve()
    print(
        "[DEPRECATED] scripts/train_meta_model.py moved to scripts/archive/experiments/train_meta_model.py.",
        file=sys.stderr,
    )
