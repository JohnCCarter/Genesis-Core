...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/analysis/analyze_feature_synergy.py").resolve()
    print(
        "[DEPRECATED] scripts/analyze_feature_synergy.py moved to scripts/archive/analysis/analyze_feature_synergy.py.",
        file=sys.stderr,
    )
