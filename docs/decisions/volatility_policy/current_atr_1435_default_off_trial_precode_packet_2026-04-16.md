...
- **Expected changed files:** `docs/decisions/volatility_policy/current_atr_1435_default_off_trial_precode_packet_2026-04-16.md`
- **Max files touched:** `1`
...
- `pre-commit run --files docs/decisions/volatility_policy/current_atr_1435_default_off_trial_precode_packet_2026-04-16.md`
