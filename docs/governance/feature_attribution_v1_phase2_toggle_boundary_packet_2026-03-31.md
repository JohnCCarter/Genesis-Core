...
- **Expected changed files:** `docs/governance/feature_attribution_v1_phase2_toggle_boundary_packet_2026-03-31.md`
- **Max files touched:** `1`
...
- `docs/analysis/regime_intelligence_parity_artifact_matrix_2026-03-17.md` — matrix-style evidence discipline
