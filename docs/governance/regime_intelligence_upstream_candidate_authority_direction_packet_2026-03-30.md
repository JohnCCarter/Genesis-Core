...
- **Expected changed files:** `docs/governance/regime_intelligence_upstream_candidate_authority_direction_packet_2026-03-30.md`
- **Max files touched:** `1`
...
This packet **narrowly supersedes** `docs/governance/regime_intelligence_optuna_signal_hypothesis_direction_packet_2026-03-27.md` **only as the active forward direction selection**.
