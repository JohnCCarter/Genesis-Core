...
- **Required Path:** `Full`
- **Objective:** Execute Phase 2A batch 2 by relocating one PoC test file to `tests/experiments/` with minimal reversible diff.
- **Candidate:** `tests/test_composable_strategy_poc.py -> tests/experiments/test_composable_strategy_poc.py`
- **Base SHA:** `2ba3a65f`

### Scope

- **Scope IN:**
  - `tests/test_composable_strategy_poc.py` (move source)
  - `tests/experiments/test_composable_strategy_poc.py` (move target)
  - `docs/audit/refactor/tests_subfolder_classification_plan_2026-03-09.md` (status/reference update)
  - `docs/audit/refactor/command_packet_tests_subfolder_classification_phase2a_batch2_2026-03-09.md`
- **Scope OUT:**
...
- `python -m ruff check .`
- `python -m pytest -q tests/experiments/test_composable_strategy_poc.py`
- `python -m pytest -q`
...
- `python -m pytest -q tests/experiments/test_composable_strategy_poc.py`: **PASS** (`8 passed`)
