...
- **Scope IN:**
  ...
  - `docs/governance/regime_intelligence_p1_off_parity_governed_baseline_reset_execution_prep_2026-03-17.md`
- **Scope OUT:**
  - `src/**`
  - `src/core/config/**`
  - `config/runtime.json`
