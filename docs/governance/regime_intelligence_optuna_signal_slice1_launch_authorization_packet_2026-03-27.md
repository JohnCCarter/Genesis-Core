...
- **Expected changed files:** `docs/governance/regime_intelligence_optuna_signal_slice1_launch_authorization_packet_2026-03-27.md`
- **Max files touched:** `1`
...
- `docs/governance/regime_intelligence_optuna_signal_first_admissible_slice_precode_command_packet_2026-03-27.md`
