...
- **Scope IN:**
  ...
  - `docs/decisions/regime_intelligence/p1_off_parity/regime_intelligence_p1_off_parity_governed_rerun_execution_plan_2026-03-17.md`
- **Scope OUT:**
  - `src/**`
  - `src/core/config/**`
  - `config/runtime.json`
