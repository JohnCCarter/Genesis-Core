...
_TARGET = (Path(__file__).resolve().parent / "archive/2026-02/analysis/run_backtest.py").resolve()
...
def _run_deprecated_cli() -> int:
    print(
        "[DEPRECATED] scripts/run_backtest.py moved to scripts/archive/2026-02/analysis/run_backtest.py.",
        file=sys.stderr,
    )
    argv = sys.argv[:]
