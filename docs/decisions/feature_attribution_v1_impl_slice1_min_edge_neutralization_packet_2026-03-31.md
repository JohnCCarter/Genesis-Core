...
- **Expected changed files:** `docs/decisions/feature_attribution_v1_impl_slice1_min_edge_neutralization_packet_2026-03-31.md`, `src/core/strategy/decision.py`, `tests/utils/test_decision_edge.py`
- **Max files touched:** `3`
