...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/experiments/probe_min_order_sizes.py").resolve()
    print(
        "[DEPRECATED] scripts/probe_min_order_sizes.py moved to scripts/archive/experiments/probe_min_order_sizes.py.",
        file=sys.stderr,
    )
