...
- **Scope IN:**
  ...
  - `docs/decisions/diagnostic_campaigns/backtest_curated_only_opt_in_precode_packet_2026-04-22.md`
- **Scope OUT:**
  ...
  - unrelated existing untracked docs: `GENESIS_WORKING_CONTRACT.md`, `docs/analysis/recommendations/ri_bucket_sample_expansion_b1_findings_2026-04-21.md`, `docs/bugs/RI_BUCKET_SAMPLE_EXPANSION_B1_20260421.md`
