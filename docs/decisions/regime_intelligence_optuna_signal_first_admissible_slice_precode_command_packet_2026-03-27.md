...
- **Expected changed files:** `docs/decisions/regime_intelligence_optuna_signal_first_admissible_slice_precode_command_packet_2026-03-27.md`
- **Max files touched:** `1`
...
2. `docs/decisions/regime_intelligence_optuna_signal_slice1_execution_outcome_signoff_summary_2026-03-27.md`
