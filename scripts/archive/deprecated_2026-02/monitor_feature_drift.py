...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/analysis/monitor_feature_drift.py").resolve()
    print(
        "[DEPRECATED] scripts/monitor_feature_drift.py moved to scripts/archive/analysis/monitor_feature_drift.py.",
        file=sys.stderr,
    )
