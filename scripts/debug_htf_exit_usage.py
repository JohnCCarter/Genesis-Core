...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/debug/2026-02-14/debug_htf_exit_usage.py").resolve()
    print(
        "[DEPRECATED] scripts/debug_htf_exit_usage.py moved to scripts/archive/debug/2026-02-14/debug_htf_exit_usage.py.",
        file=sys.stderr,
    )
