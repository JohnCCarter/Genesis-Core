...
- prior env-profile slice:
  - `docs/governance/current_atr_900_env_profile_packet_2026-04-16.md`
...
- `docs/governance/current_atr_1435_default_off_trial_packet_2026-04-16.md`
...
- `pre-commit run --files docs/governance/current_atr_900_multi_year_env_robustness_packet_2026-04-16.md tmp/current_atr_900_multi_year_env_robustness_20260416.py`
