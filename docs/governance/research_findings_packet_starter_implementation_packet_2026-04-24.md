...
- **Baseline / frozen references:**
  - `docs/governance/research_findings_preflight_lookup_implementation_packet_2026-04-24.md`
...
- **Scope IN:**
  - `docs/governance/research_findings_packet_starter_implementation_packet_2026-04-24.md`
