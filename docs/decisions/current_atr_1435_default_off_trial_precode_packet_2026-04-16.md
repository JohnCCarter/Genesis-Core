...
- **Expected changed files:** `docs/decisions/current_atr_1435_default_off_trial_precode_packet_2026-04-16.md`
- **Max files touched:** `1`
...
- `pre-commit run --files docs/decisions/current_atr_1435_default_off_trial_precode_packet_2026-04-16.md`
...
- `1435` policy validation:
  ...
  - `docs/decisions/current_atr_1435_policy_validation_packet_2026-04-16.md`
- `900` vs `1435` handoff:
  - `docs/decisions/current_atr_900_vs_1435_policy_handoff_2026-04-16.md`
- `1435` future-boundary handoff:
  - `docs/decisions/current_atr_1435_default_off_rollout_boundary_packet_2026-04-16.md`
