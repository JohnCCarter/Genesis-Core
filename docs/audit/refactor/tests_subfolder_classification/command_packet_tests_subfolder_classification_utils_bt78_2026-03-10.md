...
- **Required Path:** `Full`
- **Objective:** Relocate `test_optimizer_runner.py` to `tests/utils/` with no behavior change.
- **Candidate:** `tests/test_optimizer_runner.py -> tests/utils/test_optimizer_runner.py`
- **Category:** `tooling`
...
- `docs/audit/refactor/command_packet_tests_subfolder_classification_utils_bt78_2026-03-10.md`
