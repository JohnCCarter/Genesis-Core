...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/debug/2026-02-14/debug_swing_detection.py").resolve()
    print(
        "[DEPRECATED] scripts/debug_swing_detection.py moved to scripts/archive/debug/2026-02-14/debug_swing_detection.py.",
        file=sys.stderr,
    )
