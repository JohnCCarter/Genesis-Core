...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/analysis/fdr_correction.py").resolve()
    print(
        "[DEPRECATED] scripts/fdr_correction.py moved to scripts/archive/analysis/fdr_correction.py.",
        file=sys.stderr,
    )
