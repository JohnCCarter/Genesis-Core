...
- **Scope IN:**
  ...
  - `docs/decisions/regime_intelligence/p1_off_parity/regime_intelligence_p1_off_parity_governed_baseline_reset_execution_approval_packet_2026-03-17.md`
- **Scope OUT:**
