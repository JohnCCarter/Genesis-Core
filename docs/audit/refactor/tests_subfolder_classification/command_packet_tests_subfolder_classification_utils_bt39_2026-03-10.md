...
- **Required Path:** `Full`
- **Objective:** Relocate `test_authority_mode_resolver.py` till `tests/utils/` med no-behavior-change.
- **Candidate:** `tests/test_authority_mode_resolver.py -> tests/utils/test_authority_mode_resolver.py`
- **Base SHA:** `1a946790`
- **Category:** `tooling`
...
- `tests/utils/test_authority_mode_resolver.py`
- `docs/audit/refactor/tests_subfolder_classification_plan_2026-03-09.md`
- `docs/audit/refactor/command_packet_tests_subfolder_classification_utils_bt39_2026-03-10.md`
...
- `python -m ruff check .`
- `python -m pytest -q tests/utils/test_authority_mode_resolver.py`
