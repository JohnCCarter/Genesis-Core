...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/test_prototypes/smoke_test_eth.py").resolve()
    print(
        "[DEPRECATED] scripts/smoke_test_eth.py moved to scripts/archive/test_prototypes/smoke_test_eth.py.",
        file=sys.stderr,
    )
