...
Status: `historical Feature Attribution v1 Phase 6 packet / retained for provenance / not current branch guidance`
...
- **Expected changed files:** `docs/decisions/feature_attribution/v1/feature_attribution_v1_phase6_artifact_report_packet_2026-03-31.md`
- **Max files touched:** `1`
...
- `docs/analysis/regime_intelligence/core/regime_intelligence_parity_artifact_matrix_2026-03-17.md` — matrix-style evidence layout only
