...
# Alla symboler
ALL_SYMBOLS = [
    "tBTCUSD", "tETHUSD", "tADAUSD", "tDOTUSD", "tDOGEUSD", "tEOSUSD",
    "tFILUSD", "tLTCUSD", "tNEARUSD", "tSOLUSD", "tXTZUSD", "tXAUTUSD",
    "tALGOUSD", "tAPTUSD", "tAVAXUSD"
]
...
def update_existing_models():
    ...
    for model_file in models_dir.glob("*.json"):
        ...
        try:
            ...
            if isinstance(data, dict) and any(isinstance(v, dict) and 'schema' in v for v in data.values()):
