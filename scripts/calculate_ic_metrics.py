...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/analysis/calculate_ic_metrics.py").resolve()
    print(
        "[DEPRECATED] scripts/calculate_ic_metrics.py moved to scripts/archive/analysis/calculate_ic_metrics.py.",
        file=sys.stderr,
    )
