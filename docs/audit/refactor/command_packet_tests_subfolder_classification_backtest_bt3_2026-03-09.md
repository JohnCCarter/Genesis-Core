...
- **Candidate:** `tests/test_backtest_position_tracker.py -> tests/backtest/test_backtest_position_tracker.py`
- **Base SHA:** `587bce3e`

### Scope

- **Scope IN:**
  - `tests/test_backtest_position_tracker.py` (move source)
  - `tests/backtest/test_backtest_position_tracker.py` (move target)
  - `docs/audit/refactor/tests_subfolder_classification_plan_2026-03-09.md` (classification/reference update)
  - `docs/audit/refactor/command_packet_tests_subfolder_classification_backtest_bt3_2026-03-09.md`
- **Scope OUT:**
...
- `python -m ruff check .`
- `python -m pytest -q tests/backtest/test_backtest_position_tracker.py`
- `python -m pytest -q`
...
- `C:/Users/fa06662/Projects/Genesis-Core/.venv/Scripts/python.exe -m pytest -q tests/backtest/test_backtest_position_tracker.py`: **PASS**
...
- `runTests` (moved file): **PASS** (`13 passed, 0 failed`)
