...
- **Expected changed files:** `docs/decisions/regime_intelligence_optuna_exit_override_plateau_closeout_2026-03-27.md`
- **Max files touched:** `1`
...
- `docs/decisions/regime_intelligence_optuna_challenger_family_slice10_execution_outcome_signoff_summary_2026-03-27.md`
