# Repo Cleanup D15 Minimal Execution Contract (2026-02-15)
...
- Move-only execution av exakt tre filer:
  1. `results/hparam_search/run_20251227_180204/trial_021.log`
  2. `results/hparam_search/run_20251227_180204/trial_022.log`
  3. `results/hparam_search/run_20251227_180204/trial_023.log`
- Målvägar (mirror under orphaned archive):
  1. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_021.log`
  2. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_022.log`
  3. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_023.log`
...
3. D15 kontrakt + rapport skapade.
...
- D15 i denna tranche är en minimal execution-batch med explicit hantering av
