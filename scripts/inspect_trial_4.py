...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/2026-02/analysis/inspect_trial_4.py").resolve()
    print(
        "[DEPRECATED] scripts/inspect_trial_4.py moved to scripts/archive/2026-02/analysis/inspect_trial_4.py.",
        file=sys.stderr,
    )
