...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/experiments/filter_model_features.py").resolve()
    print(
        "[DEPRECATED] scripts/filter_model_features.py moved to scripts/archive/experiments/filter_model_features.py.",
        file=sys.stderr,
    )
