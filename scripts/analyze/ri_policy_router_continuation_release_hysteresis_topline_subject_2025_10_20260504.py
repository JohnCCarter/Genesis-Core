...
ARTIFACT_DIR = (
    ...
    / "results"
    / "backtests"
    / "ri_policy_router_continuation_release_hysteresis_topline_subject_2025_10_20260504"
)
SUMMARY_PATH = ARTIFACT_DIR / "continuation_release_hysteresis_topline_subject_2025_10_summary.json"
ROW_DIFFS_PATH = (
    ARTIFACT_DIR / "continuation_release_hysteresis_topline_subject_2025_10_row_diffs.json"
)
...
def main() -> int:
    ...
    normalized_summary = {
        ...
        "comparison": {
            ...
            "release_zero_continuation_release_timestamps": sorted(
                release_zero_rows_ts for release_zero_rows_ts in release_zero_release_rows
            ),
