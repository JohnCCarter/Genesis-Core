...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/debug/2026-02-14/debug_model_bias.py").resolve()
    print(
        "[DEPRECATED] scripts/debug_model_bias.py moved to scripts/archive/debug/2026-02-14/debug_model_bias.py.",
        file=sys.stderr,
    )
