...
- **Required Path:** `Full`
- **Objective:** Relocate `test_optuna_config_cache.py` to `tests/utils/` with no behavior change.
- **Candidate:** `tests/test_optuna_config_cache.py -> tests/utils/test_optuna_config_cache.py`
- **Category:** `tooling`
- **Constraints:** `NO BEHAVIOR CHANGE`

### Scope IN

- `tests/test_optuna_config_cache.py`
- `tests/utils/test_optuna_config_cache.py`
- `docs/audit/refactor/tests_subfolder_classification_plan_2026-03-09.md`
- `docs/audit/refactor/command_packet_tests_subfolder_classification_utils_bt88_2026-03-10.md`
