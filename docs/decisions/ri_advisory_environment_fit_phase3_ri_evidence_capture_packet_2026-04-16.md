...
- `pre-commit run --files docs/decisions/ri_advisory_environment_fit_phase3_ri_evidence_capture_packet_2026-04-16.md tmp/ri_advisory_environment_fit_capture_20260416.py`
