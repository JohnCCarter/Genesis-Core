...
- **Expected changed files:** `docs/governance/regime_intelligence_pre_fib_candidate_boundary_observability_opening_admissibility_packet_2026-03-30.md`
- **Max files touched:** `1`
...
- `docs/governance/regime_intelligence_experiment_map_post_binding_roadmap_2026-03-30.md`
