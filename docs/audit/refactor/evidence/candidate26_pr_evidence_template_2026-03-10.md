...
- Command packet (current retained path): `docs/audit/refactor/candidates/command_packet_candidate26_delete_docs_archive_features_semantic_batch_2026-03-10.md`
