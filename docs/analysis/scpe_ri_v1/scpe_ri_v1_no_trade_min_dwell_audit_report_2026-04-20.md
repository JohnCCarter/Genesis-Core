...
Packet: `docs/decisions/scpe_ri_v1/scpe_ri_v1_no_trade_min_dwell_audit_packet_2026-04-20.md`
...
- `docs/decisions/scpe_ri_v1/scpe_ri_v1_no_trade_min_dwell_audit_packet_2026-04-20.md`
- `docs/analysis/scpe_ri_v1/scpe_ri_v1_no_trade_min_dwell_audit_report_2026-04-20.md`
...
4. Determinism + replay-root immutability proof:
   ...
   - Result: `PASS`
5. `pre-commit run --files docs/decisions/scpe_ri_v1/scpe_ri_v1_no_trade_min_dwell_audit_packet_2026-04-20.md docs/analysis/scpe_ri_v1/scpe_ri_v1_no_trade_min_dwell_audit_report_2026-04-20.md scripts/analyze/scpe_ri_v1_no_trade_min_dwell_audit.py results/evaluation/scpe_ri_v1_no_trade_min_dwell_audit_2026-04-20.json`
