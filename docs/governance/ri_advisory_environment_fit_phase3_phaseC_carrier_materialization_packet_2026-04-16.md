...
- `pre-commit run --files docs/governance/ri_advisory_environment_fit_phase3_phaseC_carrier_materialization_packet_2026-04-16.md config/strategy/candidates/3h/tBTCUSD_3h_phaseC_oos_materialized_carrier_20260416.json`
