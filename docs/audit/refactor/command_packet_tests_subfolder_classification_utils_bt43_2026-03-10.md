...
- **Required Path:** `Full`
- **Objective:** Relocate `test_optimizer_champion.py` to `tests/utils/` with no behavior change.
- **Candidate:** `tests/test_optimizer_champion.py -> tests/utils/test_optimizer_champion.py`
- **Category:** `tooling`
- **Constraints:** `NO BEHAVIOR CHANGE`

### Scope IN

- `tests/test_optimizer_champion.py`
- `tests/utils/test_optimizer_champion.py`
- `docs/audit/refactor/tests_subfolder_classification_plan_2026-03-09.md`
- `docs/audit/refactor/command_packet_tests_subfolder_classification_utils_bt43_2026-03-10.md`
