...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/test_prototypes/smoke_test.py").resolve()
    print(
        "[DEPRECATED] scripts/smoke_test.py moved to scripts/archive/test_prototypes/smoke_test.py.",
        file=sys.stderr,
    )
