...
- **Expected changed files:** `docs/decisions/regime_intelligence/experiment_map/regime_intelligence_experiment_map_reselection_regime_definition_candidate_surface_packet_2026-03-30.md`
- **Max files touched:** `1`
...
- `docs/analysis/regime_intelligence/core/regime_intelligence_signal_regime_definition_roadmap_2026-03-27.md`
...
- it matches the earlier regime-definition planning line already documented in `docs/analysis/regime_intelligence/core/regime_intelligence_signal_regime_definition_roadmap_2026-03-27.md`
