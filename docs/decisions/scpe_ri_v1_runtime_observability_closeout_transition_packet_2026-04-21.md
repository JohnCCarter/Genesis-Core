...
- **Expected changed files:**
  - `docs/decisions/scpe_ri_v1_runtime_observability_closeout_transition_packet_2026-04-21.md`
  - downstream separate pre-code packet only if this packet affirms the next lane
- **Max files touched:** `2`

### Gates required

- `pre-commit run --files docs/decisions/scpe_ri_v1_runtime_observability_closeout_transition_packet_2026-04-21.md docs/decisions/scpe_ri_v1_paper_shadow_slice1_precode_packet_2026-04-21.md docs/decisions/scpe_ri_v1_runtime_observability_closeout_to_paper_shadow_implementation_report_2026-04-21.md`
...
- `docs/analysis/scpe_ri_v1_runtime_integration_roadmap_2026-04-20.md`
- `docs/analysis/scpe_ri_v1_runtime_integration_seam_inventory_2026-04-20.md`
- `docs/decisions/scpe_ri_v1_runtime_observability_transition_packet_2026-04-21.md`
- `docs/decisions/scpe_ri_v1_runtime_observability_slice1_precode_packet_2026-04-21.md`
- `docs/analysis/scpe_ri_v1_runtime_observability_slice1_implementation_report_2026-04-21.md`
- `docs/analysis/scpe_ri_v1_runtime_observability_smoke_evidence_2026-04-21.md`
- `docs/decisions/scpe_ri_v1_runtime_observability_slice2_ui_consumer_precode_packet_2026-04-21.md`
- `docs/analysis/scpe_ri_v1_runtime_observability_slice2_ui_consumer_implementation_report_2026-04-21.md`
