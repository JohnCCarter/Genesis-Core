...
| `docs/governance/regime_intelligence_optuna_challenger_family_slice7_execution_outcome_signoff_summary_2026-03-24.md` | slice-7 counts as successful challenger evidence only; promotion/anchor/freeze remained explicitly out of scope                          |
