...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/2026-02/analysis/list_top_trials.py").resolve()
    print(
        "[DEPRECATED] scripts/list_top_trials.py moved to scripts/archive/2026-02/analysis/list_top_trials.py.",
        file=sys.stderr,
    )
