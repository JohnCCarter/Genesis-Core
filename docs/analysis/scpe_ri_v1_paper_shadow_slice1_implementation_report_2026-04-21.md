...
- this report: `docs/analysis/scpe_ri_v1_paper_shadow_slice1_implementation_report_2026-04-21.md`
...
6. `pre-commit run --files docs/decisions/scpe_ri_v1_paper_shadow_slice1_precode_packet_2026-04-21.md scripts/paper_trading_runner.py tests/integration/test_paper_trading_runner.py`
...
- `pre-commit run --files docs/decisions/scpe_ri_v1_paper_shadow_slice1_precode_packet_2026-04-21.md docs/analysis/scpe_ri_v1_paper_shadow_slice1_implementation_report_2026-04-21.md scripts/paper_trading_runner.py tests/integration/test_paper_trading_runner.py`
...
- A separate out-of-scope whitespace diff may still exist in `docs/analysis/scpe_ri_v1_runtime_observability_slice1_implementation_report_2026-04-21.md`; it was not touched in this slice.
