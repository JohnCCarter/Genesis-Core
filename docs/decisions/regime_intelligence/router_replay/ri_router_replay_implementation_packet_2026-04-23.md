...
- `docs/decisions/regime_intelligence/router_replay/ri_router_replay_evidence_slice_precode_packet_2026-04-23.md`
...
- **Baseline / frozen references:**
  - `docs/analysis/regime_intelligence/router_replay/ri_router_replay_concept_case_2026-04-23.md`
  - `docs/decisions/regime_intelligence/router_replay/ri_router_replay_evidence_slice_precode_packet_2026-04-23.md`
  - `docs/analysis/scpe_ri_v1/scpe_ri_v1_router_replay_plan_2026-04-20.md`
  - `docs/decisions/scpe_ri_v1/scpe_ri_v1_research_closeout_report_2026-04-20.md` (boundary proof only)
...
- **Scope IN:**
  - `docs/decisions/regime_intelligence/router_replay/ri_router_replay_implementation_packet_2026-04-23.md`
...
1. `pre-commit run --files docs/decisions/regime_intelligence/router_replay/ri_router_replay_implementation_packet_2026-04-23.md tmp/ri_router_replay_v1_20260423.py`
