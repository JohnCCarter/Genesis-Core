...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/test_prototypes/2026-02-14/test_ws_auth.py").resolve()
    print(
        "[DEPRECATED] scripts/test_ws_auth.py moved to scripts/archive/test_prototypes/2026-02-14/test_ws_auth.py.",
        file=sys.stderr,
    )
