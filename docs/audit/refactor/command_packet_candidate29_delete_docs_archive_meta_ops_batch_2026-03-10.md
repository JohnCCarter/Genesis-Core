# Command Packet — Candidate 29 Delete deprecated meta/ops docs batch (2026-03-10)
...
- **Required Path:** `Full`
- **Objective:** Continue governed cleanup by deleting 4 low-risk deprecated meta/operations docs.
...
- **Scope IN:**
  - Delete targets listed in `docs/audit/refactor/evidence/candidate29_meta_ops_delete_manifest_2026-03-10.tsv` (4 files)
  - `docs/audit/refactor/command_packet_candidate29_delete_docs_archive_meta_ops_batch_2026-03-10.md`
  ...
  - `docs/audit/refactor/evidence/candidate29_post_delete_scope_drift_2026-03-10.txt` (to be generated)
  - `docs/audit/refactor/evidence/candidate29_gate_transcript_2026-03-10.md` (to be generated)
  - `docs/audit/refactor/evidence/candidate29_meta_ops_implementation_report_2026-03-10.md` (to be generated)
  - `docs/audit/refactor/evidence/candidate29_pr_evidence_template_2026-03-10.md` (to be generated)
- **Scope OUT:**
  - `src/**`
  - `config/**`
...
- **Expected changed files:** `16` (4 deletes + up to 12 governance/evidence files)
- **Max files touched:** `18`

### Constraints

Constraint: **NO BEHAVIOR CHANGE**.
Primary change set for Candidate29 is deletion of the 4 manifest-listed files only.
...
- Candidate decision: `docs/audit/refactor/evidence/docs_archive_triage_meta_ops_batch_candidate29_decision_2026-03-10.md`
- Manifest: `docs/audit/refactor/evidence/candidate29_meta_ops_delete_manifest_2026-03-10.tsv`
...
- Scope drift proof (to generate): `docs/audit/refactor/evidence/candidate29_post_delete_scope_drift_2026-03-10.txt`
- Gate transcript (to generate): `docs/audit/refactor/evidence/candidate29_gate_transcript_2026-03-10.md`
...
- Invocation evidence: `docs/audit/refactor/evidence/candidate29_skill_invocation_2026-03-10.txt`.
...
- Run full gate set **pre** and **post** candidate29 deletion.
