# Command Packet — Candidate 25 Delete deprecated phase3 features batch (2026-03-10)
...
- **Required Path:** `Full`
- **Objective:** Continue governed cleanup by deleting 10 low-risk deprecated phase3 feature docs in a concentrated subtree.
...
- **Scope IN:**
  - Delete targets listed in `docs/audit/refactor/evidence/candidate25_phase3_features_delete_manifest_2026-03-10.tsv` (10 files)
  ...
  - `docs/audit/refactor/evidence/candidate25_post_delete_scope_drift_2026-03-10.txt` (to be generated)
  - `docs/audit/refactor/evidence/candidate25_gate_transcript_2026-03-10.md` (to be generated)
  - `docs/audit/refactor/evidence/candidate25_phase3_features_implementation_report_2026-03-10.md` (to be generated)
  - `docs/audit/refactor/evidence/candidate25_pr_evidence_template_2026-03-10.md` (to be generated)
- **Scope OUT:**
  - `src/**`
  - `config/**`
...
- **Expected changed files:** `22` (10 deletes + up to 12 governance/evidence files)
- **Max files touched:** `24`
...
- Candidate decision: `docs/audit/refactor/evidence/docs_archive_triage_phase3_features_batch_candidate25_decision_2026-03-10.md`
- Manifest: `docs/audit/refactor/evidence/candidate25_phase3_features_delete_manifest_2026-03-10.tsv`
...
- Scope drift proof (to generate): `docs/audit/refactor/evidence/candidate25_post_delete_scope_drift_2026-03-10.txt`
- Gate transcript (to generate): `docs/audit/refactor/evidence/candidate25_gate_transcript_2026-03-10.md`
...
- Invocation evidence: `docs/audit/refactor/evidence/candidate25_skill_invocation_2026-03-10.txt`.
...
- Run full gate set **pre** and **post** candidate25 deletion.
