...
- **Baseline / frozen references:**
  ...
  - `docs/governance/ri_policy_router_low_zone_bars8_evidence_floor_runtime_packet_2026-04-27.md`
...
- **Scope IN:**
  - `docs/governance/ri_policy_router_aged_weak_plus_stability_interaction_precode_packet_2026-04-27.md`
  - `GENESIS_WORKING_CONTRACT.md`
- **Scope OUT:**
  - `src/**`
  - `tests/**`
...
1. `pre-commit run --files GENESIS_WORKING_CONTRACT.md docs/governance/ri_policy_router_aged_weak_plus_stability_interaction_precode_packet_2026-04-27.md`
