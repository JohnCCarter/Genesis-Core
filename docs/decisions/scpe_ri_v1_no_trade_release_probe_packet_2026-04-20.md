...
- `pre-commit run --files docs/decisions/scpe_ri_v1_no_trade_release_probe_packet_2026-04-20.md docs/analysis/scpe_ri_v1_no_trade_release_probe_report_2026-04-20.md scripts/analyze/scpe_ri_v1_no_trade_release_probe.py results/evaluation/scpe_ri_v1_no_trade_release_probe_2026-04-20.json`
