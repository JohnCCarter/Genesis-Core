...
- **Scope IN:**
  - `docs/decisions/regime_intelligence/advisory_environment_fit/ri_advisory_environment_fit_trade_level_deterministic_baseline_implementation_readiness_packet_2026-04-17.md`
...
- `pre-commit run --files docs/decisions/regime_intelligence/advisory_environment_fit/ri_advisory_environment_fit_trade_level_deterministic_baseline_implementation_readiness_packet_2026-04-17.md docs/analysis/regime_intelligence/advisory_environment_fit/ri_advisory_environment_fit_trade_level_deterministic_baseline_implementation_readiness_2026-04-17.md`
