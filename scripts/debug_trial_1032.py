...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/debug/debug_trial_1032.py").resolve()
    print(
        "[DEPRECATED] scripts/debug_trial_1032.py moved to scripts/archive/debug/debug_trial_1032.py.",
        file=sys.stderr,
    )
