...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/analysis/analyze_feature_importance.py").resolve()
    print(
        "[DEPRECATED] scripts/analyze_feature_importance.py moved to scripts/archive/analysis/analyze_feature_importance.py.",
        file=sys.stderr,
    )
