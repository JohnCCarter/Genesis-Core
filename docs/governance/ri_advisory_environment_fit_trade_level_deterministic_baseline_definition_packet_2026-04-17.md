...
- `pre-commit run --files docs/governance/ri_advisory_environment_fit_trade_level_deterministic_baseline_definition_packet_2026-04-17.md docs/analysis/ri_advisory_environment_fit_trade_level_deterministic_baseline_definition_2026-04-17.md`
