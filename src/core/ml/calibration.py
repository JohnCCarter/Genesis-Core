...
def apply_calibration_from_params(
    ...
    if method == "platt":
        ...
        warnings.warn(
            "Isotonic regression parameters cannot be easily reconstructed. Returning original probabilities.",
            stacklevel=2,
        )
        return y_pred_proba
...
def compare_calibration_methods(
    ...
    return {
        ...
        "best_improvement": float(
            min(original_brier - platt_brier, original_brier - isotonic_brier)
        ),
    }
