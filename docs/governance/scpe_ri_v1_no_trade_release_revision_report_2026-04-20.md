...
Packet: `docs/governance/scpe_ri_v1_no_trade_release_revision_packet_2026-04-20.md`
...
4. Determinism + baseline replay-root immutability proof:
   ...
   - Result: `PASS`
5. `pre-commit run --files docs/governance/scpe_ri_v1_no_trade_release_revision_packet_2026-04-20.md docs/governance/scpe_ri_v1_no_trade_release_revision_report_2026-04-20.md scripts/analyze/scpe_ri_v1_no_trade_release_revision.py results/evaluation/scpe_ri_v1_no_trade_release_revision_2026-04-20.json`
