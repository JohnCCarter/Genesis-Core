# Repo Cleanup D20 Minimal Execution Contract (2026-02-15)
...
- Move-only execution av exakt tre filer:
  1. `results/hparam_search/run_20251227_180204/trial_036.log`
  2. `results/hparam_search/run_20251227_180204/trial_037.log`
  3. `results/hparam_search/run_20251227_180204/trial_038.log`
- Målvägar (mirror under orphaned archive):
  1. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_036.log`
  2. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_037.log`
  3. `archive/_orphaned/results/hparam_search/run_20251227_180204/trial_038.log`
...
- Basename-referenser finns i run-artefakter och accepteras som residual risk:
  - `results/hparam_search/run_20251227_180204/trial_036.json:113`
  - `results/hparam_search/run_20251227_180204/trial_037.json:111`
  - `results/hparam_search/run_20251227_180204/trial_038.json:109`
...
2. D20 kontrakt + rapport skapade.
...
- D20 i denna tranche är en minimal execution-batch med explicit noterad basename-residual risk.
