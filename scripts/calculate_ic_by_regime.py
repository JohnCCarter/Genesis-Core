...
def print_regime_results(regime_results: dict, regime_name: str):
    ...
    for regime, stats in regime_results.items():
        ...
        print(f"  Q5-Q1 Spread:   {stats['q5_q1_spread']:+.4%}" if stats['q5_q1_spread'] else "  Q5-Q1 Spread:   N/A")
...
def main():
    ...
    parser.add_argument("--horizon", type=int, default=10, help="Forward return horizon (default: 10)")
    ...
    try:
        ...
        for i, reg in enumerate(all_regimes[:5], 1):
            print(f"{i}. {reg['type']}/{reg['name']}: IC={reg['ic']:+.4f}, "
