...
def main() -> int:
    ...
    target = (
        wrapper.parent / "archive/test_prototypes/2026-02-14/test_exit_fibonacci.py"
    ).resolve()
    print(
        "[DEPRECATED] scripts/test_exit_fibonacci.py moved to scripts/archive/test_prototypes/2026-02-14/test_exit_fibonacci.py.",
        file=sys.stderr,
    )
