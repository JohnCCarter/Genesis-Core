...
def main() -> int:
    ...
    target = (wrapper.parent / "archive/analysis/benchmark_optimizations.py").resolve()
    print(
        "[DEPRECATED] scripts/benchmark_optimizations.py moved to scripts/archive/analysis/benchmark_optimizations.py.",
        file=sys.stderr,
    )
