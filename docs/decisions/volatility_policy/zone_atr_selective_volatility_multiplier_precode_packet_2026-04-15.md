...
- **Scope IN:**
  - `docs/decisions/volatility_policy/zone_atr_selective_volatility_multiplier_precode_packet_2026-04-15.md`
...
- `pre-commit run --files src/core/strategy/decision_sizing.py src/core/config/schema.py src/core/config/authority.py tests/utils/test_decision_sizing.py tests/utils/test_decision_scenario_behavior.py tests/governance/test_config_schema_backcompat.py tests/integration/test_golden_trace_runtime_semantics.py docs/decisions/volatility_policy/zone_atr_selective_volatility_multiplier_precode_packet_2026-04-15.md`
