# Command Packet — Candidate 27 Delete deprecated analysis/calibration/risk batch (2026-03-10)
...
- **Required Path:** `Full`
- **Objective:** Continue governed cleanup by deleting 10 low-risk deprecated docs from analysis/calibration/data/risk subtrees.
...
- **Scope IN:**
  - Delete targets listed in `docs/audit/refactor/evidence/candidate27_analysis_calibration_risk_delete_manifest_2026-03-10.tsv` (10 files)
  ...
  - `docs/audit/refactor/evidence/candidate27_post_delete_scope_drift_2026-03-10.txt` (to be generated)
  - `docs/audit/refactor/evidence/candidate27_gate_transcript_2026-03-10.md` (to be generated)
  - `docs/audit/refactor/evidence/candidate27_analysis_calibration_risk_implementation_report_2026-03-10.md` (to be generated)
  - `docs/audit/refactor/evidence/candidate27_pr_evidence_template_2026-03-10.md` (to be generated)
- **Scope OUT:**
  - `src/**`
  - `config/**`
...
- **Expected changed files:** `21` (10 deletes + up to 11 governance/evidence files)
- **Max files touched:** `23`

### Constraints

Constraint: **NO BEHAVIOR CHANGE**.
Primary change set for Candidate27 is deletion of the 10 manifest-listed files only.
Triage matrix/summary files are metadata-only and remain unchanged unless an explicit traceability update is required for this candidate.
...
- Candidate decision: `docs/audit/refactor/evidence/docs_archive_triage_analysis_calibration_risk_batch_candidate27_decision_2026-03-10.md`
- Manifest: `docs/audit/refactor/evidence/candidate27_analysis_calibration_risk_delete_manifest_2026-03-10.tsv`
...
- Scope drift proof (to generate): `docs/audit/refactor/evidence/candidate27_post_delete_scope_drift_2026-03-10.txt`
- Gate transcript (to generate): `docs/audit/refactor/evidence/candidate27_gate_transcript_2026-03-10.md`
...
- Executable skill evidence for this candidate is the recorded `scripts/run_skill.py --manifest dev --dry-run` invocations for `repo_clean_refactor` and `python_engineering`.
- Any additional planning-skill usage is treated as non-blocking context unless separately evidenced.
- Invocation evidence: `docs/audit/refactor/evidence/candidate27_skill_invocation_2026-03-10.txt`.
...
- Run full gate set **pre** and **post** candidate27 deletion.
