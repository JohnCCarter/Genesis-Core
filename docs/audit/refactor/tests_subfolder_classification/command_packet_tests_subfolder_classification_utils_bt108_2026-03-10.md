...
- **Required Path:** `Full`
- **Objective:** Relocate `test_train_model.py` to `tests/utils/` with no behavior change.
- **Candidate:** `tests/test_train_model.py -> tests/utils/test_train_model.py`
- **Category:** `tooling`
...
- `tests/utils/test_train_model.py`
- `docs/audit/refactor/tests_subfolder_classification_plan_2026-03-09.md`
- `docs/audit/refactor/command_packet_tests_subfolder_classification_utils_bt108_2026-03-10.md`
