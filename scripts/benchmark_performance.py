...
def main():
    ...
    parser.add_argument(
        "--iterations", type=int, default=10, help="Iterations per test (default: 10)"
    )
    ...
    all_results = {
        ...
        "fibonacci": benchmark_htf_fibonacci(
            data, max(args.iterations // 2, 3)
        ),  # Fewer iterations for heavy tests
    }
