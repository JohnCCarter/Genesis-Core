...
5. `docs/analysis/scpe_ri_v1/scpe_ri_v1_runtime_integration_seam_inventory_2026-04-20.md` classed the paper-runner seam as operationally later than earlier SCPE RI lanes.
6. `docs/decisions/scpe_ri_v1/scpe_ri_v1_runtime_observability_closeout_transition_packet_2026-04-21.md` preserved the carry-forward rule that later paper-shadow work remains separately governed and citation-only with respect to `scripts/paper_trading_runner.py`, `docs/paper_trading/runner_deployment.md`, and `docs/paper_trading/phase3_runbook.md` until separately packeted.
