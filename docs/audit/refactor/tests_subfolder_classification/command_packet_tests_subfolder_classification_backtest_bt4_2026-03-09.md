...
- **Candidate:** `tests/test_backtest_entry_reasons.py -> tests/backtest/test_backtest_entry_reasons.py`
- **Base SHA:** `d43da512`
- **Category:** `tooling`
...
- **Scope IN:**
  - `tests/test_backtest_entry_reasons.py` (move source)
  - `tests/backtest/test_backtest_entry_reasons.py` (move target)
  - `docs/audit/refactor/tests_subfolder_classification_plan_2026-03-09.md` (classification/reference update)
  - `docs/audit/refactor/command_packet_tests_subfolder_classification_backtest_bt4_2026-03-09.md`
- **Scope OUT:**
...
- `python -m ruff check .`
- `python -m pytest -q tests/backtest/test_backtest_entry_reasons.py`
- `python -m pytest -q`
...
- Opus pre-code review: **APPROVED_WITH_NOTES**
- Packet remediation applied: Category/Constraints/Done criteria added before implementation.
...
- `C:/Users/fa06662/Projects/Genesis-Core/.venv/Scripts/python.exe -m pytest -q tests/backtest/test_backtest_entry_reasons.py`: **PASS**
